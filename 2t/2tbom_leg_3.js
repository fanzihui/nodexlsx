...
const get_file = fs.readFileSync(`${dir_name}/src/2t/BOMLEG_3.xlsx`)
// 读取文件
            ...
            if(i == switch_i){
                switch(workSheetsFromBuffer[0].data[i][8]){
                    case switch_case:
                        ...
                        // } else if (orbital > 4.7 && orbital <= 5.6){
                        //     product_num = 2*5+2
                        //     arr.push(product_num)
                        ...
                        //     product_num = 2*7+2
                        //     arr.push(product_num)
                        // } else if (orbital > 7.3 && orbital <= 7.5){
                        //     product_num = 2*8+2
                        //     arr.push(product_num)
                        // }
...
setExcel(span,orbital,'14˂S≤17m',4)
// 2t 11˂S≤14米
